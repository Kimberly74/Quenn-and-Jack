<html>
    ...
    <body>
        ...
        <div class="cabecera">   
            ...
            <label id="titulo" class="nombre">Clientes</label>
        <img class="fotouser" src="../source/img/user.png" alt="User" style="height: 50%;">
        </div><br>
        
        <a id="azul" href="agregar.php">NUEVO CLIENTE</a><br><br>
        <div id="tabla">
            <table>
                <thead>
                    <tr>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <?php echo "<a onclick='editar()' id='azul' href='editar.php?id=".$filas['id']."'>EDITAR</a>";  ?>
                            |
